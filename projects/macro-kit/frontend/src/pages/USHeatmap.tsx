...
const GROUPS_META: {
...
}[] = [
  {
    ...
    indicators: [
      { name: 'Real GDP (q/q, SAAR)',            asOfLastMtg: '2.4%',  latest: '-0.3%', change: '-2.7',  lastUpd: '30 Apr 2025', units: '% q/q SA',  mean: -0.3,  std: 0.8,   amp: 0.9, phase: 0.2, freq: 0.28, noiseSeed: 101 },
      { name: 'Manufacturing Production (m/m)',   asOfLastMtg: '0.1%',  latest: '0.3%',  change: '+0.2',  lastUpd: '16 May 2025', units: '% m/m SA',  mean: 0.3,   std: 0.5,   amp: 1.0, phase: 0.5, freq: 0.48, noiseSeed: 102 },
      { name: 'Construction Spending (m/m)',      asOfLastMtg: '0.5%',  latest: '0.2%',  change: '-0.3',  lastUpd: '01 May 2025', units: '% m/m SA',  mean: 0.2,   std: 0.6,   amp: 0.9, phase: 0.8, freq: 0.36, noiseSeed: 103 },
      { name: 'Retail Sales ex-Auto Fuel (m/m)',  asOfLastMtg: '0.3%',  latest: '0.5%',  change: '+0.2',  lastUpd: '15 May 2025', units: '% m/m SA',  mean: 0.5,   std: 0.5,   amp: 1.0, phase: 1.0, freq: 0.44, noiseSeed: 104 },
      { name: 'Light Vehicle Sales (mn. SAAR)',   asOfLastMtg: '17.8',  latest: '18.2',  change: '+0.4',  lastUpd: '01 May 2025', units: 'mn. SAAR',  mean: 18.2,  std: 1.2,   amp: 1.1, phase: 0.7, freq: 0.46, noiseSeed: 105 },
      { name: 'Household Consumption (q/q)',      asOfLastMtg: '4.2%',  latest: '1.8%',  change: '-2.4',  lastUpd: '30 Apr 2025', units: '% q/q SA',  mean: 1.8,   std: 0.8,   amp: 0.8, phase: 1.2, freq: 0.28, noiseSeed: 106 },
      { name: 'Business Investment (q/q)',        asOfLastMtg: '2.9%',  latest: '4.1%',  change: '+1.2',  lastUpd: '30 Apr 2025', units: '% q/q SA',  mean: 4.1,   std: 1.5,   amp: 0.8, phase: 1.4, freq: 0.26, noiseSeed: 107 },
    ],
  },
  {
    name: 'Business Activity', bias: -0.1,
    indicators: [
      { name: 'ISM Manufacturing PMI',            asOfLastMtg: '49.0',  latest: '48.7',  change: '-0.3',  lastUpd: '01 May 2025', units: 'Index SA',  mean: 48.7,  std: 2.5,   amp: 1.2, phase: 0.4, freq: 0.48, noiseSeed: 108 },
      { name: 'ISM Mfg New Orders',               asOfLastMtg: '47.6',  latest: '47.2',  change: '-0.4',  lastUpd: '01 May 2025', units: 'Index SA',  mean: 47.2,  std: 3.0,   amp: 1.3, phase: 0.5, freq: 0.50, noiseSeed: 109 },
      { name: 'ISM Services PMI',                 asOfLastMtg: '50.8',  latest: '51.6',  change: '+0.8',  lastUpd: '05 May 2025', units: 'Index SA',  mean: 51.6,  std: 2.2,   amp: 1.1, phase: 0.6, freq: 0.46, noiseSeed: 110 },
      { name: 'ISM Services New Orders',          asOfLastMtg: '52.2',  latest: '52.3',  change: '+0.1',  lastUpd: '05 May 2025', units: 'Index SA',  mean: 52.3,  std: 2.5,   amp: 1.0, phase: 0.7, freq: 0.47, noiseSeed: 111 },
      { name: 'S&P Global Composite PMI',         asOfLastMtg: '52.1',  latest: '50.6',  change: '-1.5',  lastUpd: '05 May 2025', units: 'Index SA',  mean: 50.6,  std: 2.0,   amp: 1.1, phase: 0.3, freq: 0.45, noiseSeed: 112 },
      { name: 'S&P Global Mfg PMI',               asOfLastMtg: '50.2',  latest: '50.2',  change: '—',     lastUpd: '01 May 2025', units: 'Index SA',  mean: 50.2,  std: 2.0,   amp: 1.2, phase: 0.4, freq: 0.49, noiseSeed: 113 },
      { name: 'S&P Global Services PMI',          asOfLastMtg: '54.4',  latest: '50.8',  change: '-3.6',  lastUpd: '05 May 2025', units: 'Index SA',  mean: 50.8,  std: 2.5,   amp: 1.0, phase: 0.6, freq: 0.46, noiseSeed: 114 },
      { name: 'Empire State Manufacturing',       asOfLastMtg: '-20.0', latest: '-8.1',  change: '+11.9', lastUpd: '15 May 2025', units: 'Balance',   mean: -8.1,  std: 18.0,  amp: 1.2, phase: 0.8, freq: 0.50, noiseSeed: 115 },
      { name: 'Philadelphia Fed Manufacturing',   asOfLastMtg: '-12.5', latest: '-26.4', change: '-13.9', lastUpd: '15 May 2025', units: 'Balance',   mean: -26.4, std: 18.0,  amp: 1.3, phase: 0.9, freq: 0.52, noiseSeed: 116 },
      { name: 'Conf. Board Consumer Confidence',  asOfLastMtg: '93.0',  latest: '86.0',  change: '-7.0',  lastUpd: '29 Apr 2025', units: 'Index',     mean: 86.0,  std: 10.0,  amp: 1.0, phase: 1.0, freq: 0.42, noiseSeed: 117 },
      { name: 'Univ. of Michigan Sentiment',      asOfLastMtg: '57.0',  latest: '52.2',  change: '-4.8',  lastUpd: '16 May 2025', units: 'Index',     mean: 52.2,  std: 8.0,   amp: 0.9, phase: 1.1, freq: 0.44, noiseSeed: 118 },
      { name: 'NFIB Small Business Optimism',     asOfLastMtg: '97.4',  latest: '95.8',  change: '-1.6',  lastUpd: '13 May 2025', units: 'Index',     mean: 95.8,  std: 5.0,   amp: 1.0, phase: 1.2, freq: 0.40, noiseSeed: 119 },
    ],
  },
  {
    name: 'Housing Market', bias: -0.6,
    indicators: [
      { name: 'NAHB Housing Market Index',        asOfLastMtg: '40',    latest: '40',    change: '—',     lastUpd: '15 May 2025', units: 'Index',     mean: 40.0,  std: 6.0,   amp: 1.0, phase: 0.4, freq: 0.34, noiseSeed: 120 },
      { name: 'Housing Starts (k SAAR)',          asOfLastMtg: '1,324', latest: '1,361', change: '+37',   lastUpd: '16 May 2025', units: 'k SAAR',    mean: 1361.0,std: 120.0, amp: 1.0, phase: 0.5, freq: 0.36, noiseSeed: 121 },
      { name: 'Building Permits (k SAAR)',        asOfLastMtg: '1,459', latest: '1,422', change: '-37',   lastUpd: '16 May 2025', units: 'k SAAR',    mean: 1422.0,std: 100.0, amp: 0.9, phase: 0.6, freq: 0.35, noiseSeed: 122 },
      { name: 'New Home Sales (k SAAR)',          asOfLastMtg: '724',   latest: '743',   change: '+19',   lastUpd: '23 Apr 2025', units: 'k SAAR',    mean: 743.0, std: 60.0,  amp: 0.9, phase: 0.7, freq: 0.32, noiseSeed: 123 },
      { name: 'Existing Home Sales (mn. SAAR)',   asOfLastMtg: '4.02',  latest: '4.02',  change: '—',     lastUpd: '22 Apr 2025', units: 'mn. SAAR',  mean: 4.02,  std: 0.25,  amp: 0.9, phase: 0.8, freq: 0.30, noiseSeed: 124 },
      { name: 'Case-Shiller HPI (m/m SA)',        asOfLastMtg: '0.3%',  latest: '0.4%',  change: '+0.1',  lastUpd: '29 Apr 2025', units: '% m/m SA',  mean: 0.4,   std: 0.4,   amp: 0.8, phase: 1.0, freq: 0.28, noiseSeed: 125 },
      { name: 'MBA Mortgage Applications (w/w)', asOfLastMtg: '+2.8%', latest: '-1.3%', change: '-4.1',  lastUpd: '14 May 2025', units: '% w/w',     mean: -1.3,  std: 5.0,   amp: 1.2, phase: 1.2, freq: 0.60, noiseSeed: 126 },
    ],
  },
  {
    name: 'Labour Market', bias: 0.1,
    indicators: [
      { name: 'Unemployment Rate',                asOfLastMtg: '4.2%',  latest: '4.2%',  change: '—',     lastUpd: '02 May 2025', units: '% SA',      mean: 4.2,   std: 0.2,   amp: 0.5, phase: 1.5, freq: 0.22, noiseSeed: 127 },
      { name: 'U-6 Unemployment Rate',            asOfLastMtg: '7.9%',  latest: '7.8%',  change: '-0.1',  lastUpd: '02 May 2025', units: '% SA',      mean: 7.8,   std: 0.4,   amp: 0.6, phase: 1.4, freq: 0.24, noiseSeed: 128 },
      { name: 'Labor Force Participation Rate',   asOfLastMtg: '62.5%', latest: '62.6%', change: '+0.1',  lastUpd: '02 May 2025', units: '% SA',      mean: 62.6,  std: 0.3,   amp: 0.4, phase: 0.5, freq: 0.18, noiseSeed: 129 },
      { name: 'Non-farm Payrolls (k)',            asOfLastMtg: '177',   latest: '177',   change: '—',     lastUpd: '02 May 2025', units: 'k SA',      mean: 177.0, std: 60.0,  amp: 1.0, phase: 0.6, freq: 0.38, noiseSeed: 130 },
      { name: 'Private Payrolls (k)',             asOfLastMtg: '167',   latest: '167',   change: '—',     lastUpd: '02 May 2025', units: 'k SA',      mean: 167.0, std: 60.0,  amp: 1.0, phase: 0.7, freq: 0.39, noiseSeed: 131 },
      { name: 'ADP Employment (k)',               asOfLastMtg: '155',   latest: '62',    change: '-93',   lastUpd: '30 Apr 2025', units: 'k SA',      mean: 62.0,  std: 60.0,  amp: 1.1, phase: 0.8, freq: 0.40, noiseSeed: 132 },
      { name: 'Initial Jobless Claims (k)',       asOfLastMtg: '225',   latest: '229',   change: '+4',    lastUpd: '15 May 2025', units: 'k SA',      mean: 229.0, std: 15.0,  amp: 0.9, phase: 0.9, freq: 0.60, noiseSeed: 133 },
      { name: 'Continuing Claims (k)',            asOfLastMtg: '1,879', latest: '1,881', change: '+2',    lastUpd: '15 May 2025', units: 'k SA',      mean: 1881.0,std: 80.0,  amp: 0.8, phase: 1.0, freq: 0.44, noiseSeed: 134 },
      { name: 'JOLTS Job Openings (mn.)',         asOfLastMtg: '7.19',  latest: '7.19',  change: '—',     lastUpd: '01 May 2025', units: 'mn. SA',    mean: 7.19,  std: 0.40,  amp: 0.9, phase: 1.1, freq: 0.30, noiseSeed: 135 },
      { name: 'JOLTS Quits Rate (%)',             asOfLastMtg: '2.1%',  latest: '2.1%',  change: '—',     lastUpd: '01 May 2025', units: '% SA',      mean: 2.1,   std: 0.15,  amp: 0.7, phase: 1.2, freq: 0.28, noiseSeed: 136 },
      { name: 'ISM Mfg Employment',               asOfLastMtg: '44.7',  latest: '46.5',  change: '+1.8',  lastUpd: '01 May 2025', units: 'Index SA',  mean: 46.5,  std: 2.5,   amp: 1.0, phase: 0.8, freq: 0.42, noiseSeed: 137 },
      { name: 'ISM Services Employment',          asOfLastMtg: '46.2',  latest: '49.0',  change: '+2.8',  lastUpd: '05 May 2025', units: 'Index SA',  mean: 49.0,  std: 2.2,   amp: 0.9, phase: 0.9, freq: 0.40, noiseSeed: 138 },
    ],
  },
  {
    name: 'Wages', bias: 0.5,
    indicators: [
      { name: 'Avg Hourly Earnings (m/m)',        asOfLastMtg: '0.3%',  latest: '0.2%',  change: '-0.1',  lastUpd: '02 May 2025', units: '% m/m SA',  mean: 0.2,   std: 0.2,   amp: 0.6, phase: 0.3, freq: 0.22, noiseSeed: 139 },
      { name: 'Avg Hourly Earnings (y/y)',        asOfLastMtg: '3.9%',  latest: '3.8%',  change: '-0.1',  lastUpd: '02 May 2025', units: '% y/y SA',  mean: 3.8,   std: 0.4,   amp: 0.7, phase: 0.5, freq: 0.21, noiseSeed: 140 },
      { name: 'Employment Cost Index (q/q)',      asOfLastMtg: '0.9%',  latest: '0.9%',  change: '—',     lastUpd: '30 Apr 2025', units: '% q/q SA',  mean: 0.9,   std: 0.2,   amp: 0.6, phase: 0.7, freq: 0.20, noiseSeed: 141 },
      { name: 'Unit Labor Costs (q/q)',           asOfLastMtg: '2.2%',  latest: '5.7%',  change: '+3.5',  lastUpd: '30 Apr 2025', units: '% q/q SA',  mean: 5.7,   std: 1.5,   amp: 1.0, phase: 0.9, freq: 0.26, noiseSeed: 142 },
      { name: 'Atlanta Fed Wage Tracker (y/y)',   asOfLastMtg: '4.4%',  latest: '4.3%',  change: '-0.1',  lastUpd: '30 Apr 2025', units: '% y/y',     mean: 4.3,   std: 0.4,   amp: 0.7, phase: 0.4, freq: 0.22, noiseSeed: 143 },
      { name: 'Productivity (q/q, SAAR)',         asOfLastMtg: '1.5%',  latest: '-0.8%', change: '-2.3',  lastUpd: '01 May 2025', units: '% q/q SA',  mean: -0.8,  std: 1.0,   amp: 0.9, phase: 0.8, freq: 0.25, noiseSeed: 144 },
    ],
  },
  {
    name: 'Inflation', bias: 0.4,
    indicators: [
      { name: 'CPI Headline (y/y)',               asOfLastMtg: '2.4%',  latest: '2.3%',  change: '-0.1',  lastUpd: '13 May 2025', units: '% y/y',     mean: 2.3,   std: 0.4,   amp: 0.8, phase: 0.0, freq: 0.26, noiseSeed: 145 },
      { name: 'CPI Core (y/y)',                   asOfLastMtg: '2.8%',  latest: '2.8%',  change: '—',     lastUpd: '13 May 2025', units: '% y/y',     mean: 2.8,   std: 0.4,   amp: 0.7, phase: 0.3, freq: 0.25, noiseSeed: 146 },
      { name: 'CPI Supercore (y/y)',              asOfLastMtg: '3.5%',  latest: '3.4%',  change: '-0.1',  lastUpd: '13 May 2025', units: '% y/y',     mean: 3.4,   std: 0.4,   amp: 0.7, phase: 0.4, freq: 0.24, noiseSeed: 147 },
      { name: 'PCE Headline (y/y)',               asOfLastMtg: '2.3%',  latest: '2.3%',  change: '—',     lastUpd: '30 Apr 2025', units: '% y/y',     mean: 2.3,   std: 0.4,   amp: 0.8, phase: 0.2, freq: 0.26, noiseSeed: 148 },
      { name: 'PCE Core (y/y)',                   asOfLastMtg: '2.6%',  latest: '2.6%',  change: '—',     lastUpd: '30 Apr 2025', units: '% y/y',     mean: 2.6,   std: 0.3,   amp: 0.7, phase: 0.4, freq: 0.25, noiseSeed: 149 },
      { name: 'PCE Supercore (y/y)',              asOfLastMtg: '3.4%',  latest: '3.5%',  change: '+0.1',  lastUpd: '30 Apr 2025', units: '% y/y',     mean: 3.5,   std: 0.4,   amp: 0.7, phase: 0.5, freq: 0.24, noiseSeed: 150 },
      { name: 'PPI Final Demand (y/y)',           asOfLastMtg: '2.7%',  latest: '2.4%',  change: '-0.3',  lastUpd: '15 May 2025', units: '% y/y',     mean: 2.4,   std: 0.8,   amp: 1.0, phase: 0.6, freq: 0.30, noiseSeed: 151 },
      { name: 'PPI Core (y/y)',                   asOfLastMtg: '3.0%',  latest: '3.1%',  change: '+0.1',  lastUpd: '15 May 2025', units: '% y/y',     mean: 3.1,   std: 0.6,   amp: 0.9, phase: 0.7, freq: 0.28, noiseSeed: 152 },
      { name: 'Import Prices (y/y)',              asOfLastMtg: '-0.1%', latest: '0.9%',  change: '+1.0',  lastUpd: '15 May 2025', units: '% y/y',     mean: 0.9,   std: 1.5,   amp: 1.1, phase: 0.8, freq: 0.34, noiseSeed: 153 },
      { name: 'Michigan Inflation Exp. 1y',       asOfLastMtg: '5.0%',  latest: '7.3%',  change: '+2.3',  lastUpd: '16 May 2025', units: '%',         mean: 7.3,   std: 1.0,   amp: 1.0, phase: 0.4, freq: 0.28, noiseSeed: 154 },
      { name: 'Michigan Inflation Exp. 5y',       asOfLastMtg: '4.1%',  latest: '4.6%',  change: '+0.5',  lastUpd: '16 May 2025', units: '%',         mean: 4.6,   std: 0.4,   amp: 0.7, phase: 0.5, freq: 0.22, noiseSeed: 155 },
      { name: 'NY Fed Inflation Exp. 3y',         asOfLastMtg: '3.0%',  latest: '3.2%',  change: '+0.2',  lastUpd: '13 May 2025', units: '%',         mean: 3.2,   std: 0.3,   amp: 0.6, phase: 0.6, freq: 0.20, noiseSeed: 156 },
    ],
  },
  {
    name: 'Financial Conditions', bias: 0.1,
    indicators: [
      { name: 'Fed Funds Rate (upper)',           asOfLastMtg: '4.50%', latest: '4.50%', change: '—',     lastUpd: '07 May 2025', units: '%',         mean: 4.50,  std: 0.25,  amp: 0.5, phase: 0.2, freq: 0.18, noiseSeed: 157 },
      { name: 'SOFR 3M',                         asOfLastMtg: '4.52%', latest: '4.31%', change: '-0.21', lastUpd: '01 Jun 2025', units: '%',         mean: 4.31,  std: 0.28,  amp: 0.6, phase: 0.3, freq: 0.20, noiseSeed: 158 },
      { name: '2y UST Yield',                    asOfLastMtg: '3.82%', latest: '3.92%', change: '+0.10', lastUpd: '01 Jun 2025', units: '%',         mean: 3.92,  std: 0.38,  amp: 0.9, phase: 0.4, freq: 0.32, noiseSeed: 159 },
      { name: '5y UST Yield',                    asOfLastMtg: '4.12%', latest: '4.20%', change: '+0.08', lastUpd: '01 Jun 2025', units: '%',         mean: 4.20,  std: 0.38,  amp: 1.0, phase: 0.5, freq: 0.34, noiseSeed: 160 },
      { name: '10y UST Yield',                   asOfLastMtg: '4.35%', latest: '4.50%', change: '+0.15', lastUpd: '01 Jun 2025', units: '%',         mean: 4.50,  std: 0.40,  amp: 1.0, phase: 0.6, freq: 0.36, noiseSeed: 161 },
      { name: '20y UST Yield',                   asOfLastMtg: '4.75%', latest: '4.88%', change: '+0.13', lastUpd: '01 Jun 2025', units: '%',         mean: 4.88,  std: 0.42,  amp: 1.0, phase: 0.7, freq: 0.38, noiseSeed: 162 },
      { name: '30y UST Yield',                   asOfLastMtg: '4.60%', latest: '4.72%', change: '+0.12', lastUpd: '01 Jun 2025', units: '%',         mean: 4.72,  std: 0.45,  amp: 1.1, phase: 0.8, freq: 0.40, noiseSeed: 163 },
      { name: '2s10s Treasury Curve',            asOfLastMtg: '53',    latest: '58',    change: '+5',    lastUpd: '01 Jun 2025', units: 'bps',       mean: 58.0,  std: 30.0,  amp: 1.0, phase: 1.2, freq: 0.38, noiseSeed: 164 },
      { name: '5s30s Treasury Curve',            asOfLastMtg: '48',    latest: '52',    change: '+4',    lastUpd: '01 Jun 2025', units: 'bps',       mean: 52.0,  std: 22.0,  amp: 0.9, phase: 1.4, freq: 0.36, noiseSeed: 165 },
      { name: '10y TIPS Yield (real)',            asOfLastMtg: '2.12%', latest: '2.18%', change: '+0.06', lastUpd: '01 Jun 2025', units: '%',         mean: 2.18,  std: 0.25,  amp: 0.8, phase: 0.5, freq: 0.32, noiseSeed: 166 },
      { name: '10y Breakeven Inflation',         asOfLastMtg: '2.23%', latest: '2.32%', change: '+0.09', lastUpd: '01 Jun 2025', units: '%',         mean: 2.32,  std: 0.20,  amp: 0.7, phase: 0.8, freq: 0.28, noiseSeed: 167 },
      { name: 'EUR/USD',                         asOfLastMtg: '1.132', latest: '1.124', change: '-0.008',lastUpd: '01 Jun 2025', units: 'FX Rate',   mean: 1.124, std: 0.03,  amp: 1.0, phase: 1.0, freq: 0.44, noiseSeed: 168 },
      { name: 'DXY',                             asOfLastMtg: '99.8',  latest: '100.2', change: '+0.4',  lastUpd: '01 Jun 2025', units: 'Index',     mean: 100.2, std: 3.5,   amp: 1.0, phase: 1.1, freq: 0.42, noiseSeed: 169 },
      { name: 'S&P 500',                         asOfLastMtg: '5,282', latest: '5,648', change: '+366',  lastUpd: '01 Jun 2025', units: 'Index',     mean: 5648.0,std: 280.0, amp: 1.1, phase: 0.9, freq: 0.46, noiseSeed: 170 },
      { name: 'Nasdaq 100',                      asOfLastMtg: '18,240',latest: '19,890',change: '+1650', lastUpd: '01 Jun 2025', units: 'Index',     mean: 19890.0,std:1200.0,amp: 1.1, phase: 1.0, freq: 0.45, noiseSeed: 171 },
    ],
  },
]
...
// 2023: deep inversion, Oct '23 peak (~5% 10y), first Fed cut Sep '24,
// Jan '25 fiscal sell-off (30y near 5%), Jun '25 partial recovery
...
export const SYNTHETIC_YIELDS: Record<Tenor, number[]> = {
  ...
  '2y':  [4.87, 4.92, 4.98, 5.03, 5.00, 4.68, 4.42, 4.38, 4.72, 4.62, 5.02, 4.87, 4.74, 4.50, 3.92, 3.55, 4.05, 4.28, 4.24, 4.26, 4.18, 3.97, 3.82, 3.98, 3.92],
  '5y':  [4.13, 4.22, 4.42, 4.60, 4.83, 4.52, 4.18, 4.03, 4.38, 4.28, 4.66, 4.55, 4.42, 4.18, 3.68, 3.52, 4.02, 4.22, 4.28, 4.52, 4.38, 4.18, 4.12, 4.22, 4.20],
  '10y': [3.84, 3.98, 4.25, 4.57, 4.93, 4.47, 3.97, 3.97, 4.25, 4.20, 4.68, 4.51, 4.36, 4.09, 3.86, 3.73, 4.20, 4.45, 4.57, 4.82, 4.52, 4.28, 4.35, 4.48, 4.50],
  '20y': [4.12, 4.28, 4.55, 4.88, 5.26, 4.80, 4.30, 4.35, 4.65, 4.60, 5.05, 4.88, 4.72, 4.48, 4.22, 4.10, 4.60, 4.88, 5.00, 5.22, 4.95, 4.68, 4.75, 4.85, 4.88],
  '30y': [3.92, 4.05, 4.32, 4.70, 5.10, 4.65, 4.12, 4.22, 4.48, 4.42, 4.90, 4.72, 4.55, 4.32, 4.08, 3.98, 4.48, 4.72, 4.85, 5.05, 4.78, 4.52, 4.60, 4.70, 4.72],
}
...
function computeYieldPCA(): YieldPCAResult {
  ...
  // Sign convention: PC1 → 10y positive (idx=2), PC2 → 30y positive (idx=4), PC3 → 5y positive (idx=1)
  ...
  return (
    <div style={cardStyle}>
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ color: '#475569', fontSize: 12, margin: '4px 0 0' }}>5 factors extracted via Dynamic Factor Model &middot; weekly monitoring of US macro fundamentals</p>
      </div>
        ...
        <div style={{ flex: '0 0 280px', display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 8, padding: '12px 14px' }}>
            ...
            {[
              ...
              'Inflation: Inflation block (~12 indicators incl. CPI/PCE/PPI)',
              'Employment: Labour Market block (~12 indicators)',
              'Wages: Wages block (~6 indicators incl. ECI, AHE)',
            ].map((note, i) => (
  ...
  return (
    <div style={cardStyle}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h2 style={{ color: '#f1f5f9', fontSize: 15, fontWeight: 600, margin: 0 }}>Treasury Yield Curve — Principal Components</h2>
          <p style={{ color: '#475569', fontSize: 12, margin: '4px 0 0' }}>PCA on 2/5/10/20/30y Treasury yields &middot; synthetic data</p>
        </div>
  ...
  return (
    <div style={cardStyle}>
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ color: '#475569', fontSize: 12, margin: '4px 0 0' }}>OLS: PC1 &amp; PC2 of Treasury curve regressed on macro factors &middot; *** p&lt;1% &nbsp;** p&lt;5% &nbsp;* p&lt;10%</p>
      </div>
...
const UST_10Y_IDX = YIELD_TENORS.indexOf('10y') // = 2

const UST_10Y_FAIR_VALUE: number[] = Array.from({ length: N_MONTHS }, (_, t) =>
  YIELD_PCA.means[UST_10Y_IDX]
  + YIELD_PCA.loadings[0][UST_10Y_IDX] * PC1_REG.fitted[t]
  + YIELD_PCA.loadings[1][UST_10Y_IDX] * PC2_REG.fitted[t]
)
const UST_10Y_PCA_FITTED: number[] = Array.from({ length: N_MONTHS }, (_, t) =>
  YIELD_PCA.means[UST_10Y_IDX]
  + YIELD_PCA.loadings[0][UST_10Y_IDX] * YIELD_PCA.scores[t][0]
  + YIELD_PCA.loadings[1][UST_10Y_IDX] * YIELD_PCA.scores[t][1]
)
const UST_10Y_RICHCHEAP: number[] = SYNTHETIC_YIELDS['10y'].map(
  (y, t) => Math.round((y - UST_10Y_FAIR_VALUE[t]) * 100 * 10) / 10
)
...
// ─── UST Fair Value Section ───────────────────────────────────────────────────

const FV_CHART_DATA = MONTH_COLS.map((month, t) => ({
  month,
  actual:    Math.round(SYNTHETIC_YIELDS['10y'][t] * 100) / 100,
  pcaFitted: Math.round(UST_10Y_PCA_FITTED[t] * 100) / 100,
  fairValue: Math.round(UST_10Y_FAIR_VALUE[t] * 100) / 100,
  richCheap: UST_10Y_RICHCHEAP[t],
}))

function USTFairValueSection() {
  const current = SYNTHETIC_YIELDS['10y'][N_MONTHS - 1]
  const fv = UST_10Y_FAIR_VALUE[N_MONTHS - 1]
  const rc = UST_10Y_RICHCHEAP[N_MONTHS - 1]
  ...
  return (
    <div style={cardStyle}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h2 style={{ color: '#f1f5f9', fontSize: 15, fontWeight: 600, margin: 0 }}>10y UST — Macro Fair Value</h2>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          {[
            ...
            { label: 'PCA (PC1+PC2)', value: `${UST_10Y_PCA_FITTED[N_MONTHS - 1].toFixed(2)}%`, color: '#34d399' },
      ...
      <ResponsiveContainer width="100%" height={220}>
        <LineChart data={FV_CHART_DATA} margin={{ top: 4, right: 12, bottom: 0, left: -8 }}>
          ...
          <Tooltip contentStyle={{ background: '#0f172a', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 8, fontSize: 11, fontFamily: 'monospace' }} labelStyle={{ color: '#64748b', marginBottom: 4 }} formatter={(v: number, name: string) => [`${v.toFixed(3)}%`, name === 'actual' ? 'Actual 10y UST' : name === 'pcaFitted' ? 'PCA (PC1+PC2)' : 'Macro Fair Value']} />
      ...
      <div style={{ display: 'flex', gap: 20, marginTop: 8, marginBottom: 20, flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><div style={{ width: 20, height: 2, background: '#f59e0b', borderRadius: 1 }} /><span style={{ color: '#475569', fontSize: 10 }}>Actual 10y UST</span></div>
      ...
      <ResponsiveContainer width="100%" height={140}>
        <AreaChart data={FV_CHART_DATA} margin={{ top: 4, right: 12, bottom: 0, left: -8 }}>
          <defs>
            <linearGradient id="gradCheapUS" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#34d399" stopOpacity={0.25} /><stop offset="95%" stopColor="#34d399" stopOpacity={0.02} /></linearGradient>
            <linearGradient id="gradRichUS" x1="0" y1="1" x2="0" y2="0"><stop offset="5%" stopColor="#f87171" stopOpacity={0.25} /><stop offset="95%" stopColor="#f87171" stopOpacity={0.02} /></linearGradient>
          </defs>
          <CartesianGrid stroke="rgba(255,255,255,0.05)" strokeDasharray="3 3" />
          <XAxis dataKey="month" tick={{ fill: '#475569', fontSize: 9, fontFamily: 'monospace' }} tickLine={false} axisLine={{ stroke: 'rgba(255,255,255,0.08)' }} interval={3} />
          ...
          <Area type="monotone" dataKey="richCheap" stroke="#94a3b8" strokeWidth={1.5} fill={rc >= 0 ? 'url(#gradCheapUS)' : 'url(#gradRichUS)'} />
        </AreaChart>
      </ResponsiveContainer>
...
function CurveDynamicsSection() {
  ...
  return (
    <div style={cardStyle}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h2 style={{ color: '#f1f5f9', fontSize: 15, fontWeight: 600, margin: 0 }}>2s10s Treasury Directionality</h2>
      ...
      <p style={{ color: '#334155', fontSize: 9, margin: '8px 0 24px', fontStyle: 'italic' }}>Bull-steepening: Treasuries rally &amp; spread widens. Bear-flattening: Treasuries sell off &amp; spread narrows. &gt;50% = macro-driven directionality.</p>
      <div>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 10, flexWrap: 'wrap', gap: 8 }}>
          <div>
            <p style={{ color: '#475569', fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.06em', margin: 0 }}>Tail likelihoods — 2s10s UST</p>
...
// ─── BE Dynamics (10y UST breakeven) ─────────────────────────────────────────
// US 10y BE = nominal 10y UST - 10y TIPS
// Synthetic TIPS: nominal - BE where BE oscillates around 2.3%
const DAILY_10Y_REAL2: number[] = DAILY_10Y.map((nom, i) => {
  const be = 0.023 + 0.003 * Math.sin(i * 0.05 + 0.8) + 0.002 * Math.cos(i * 0.12 + 1.2)
  return nom - be
})
    ...
    <div style={cardStyle}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <p style={{ color: '#475569', fontSize: 12, margin: '4px 0 0' }}>US 10y nominal UST vs real yield (TIPS) &middot; 4-regime BE directionality &middot; 3m rolling</p>
        </div>
        <div style={{ display: 'flex', gap: 8 }}>
          {[
...
function fmtTimestamp(d: Date): string {
  return d.toLocaleString('en-US', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false })
}
    ...
    <div style={{ minHeight: '100vh', background: '#080d1a' }}>
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 24px', background: 'rgba(8,13,26,0.85)', borderBottom: '1px solid rgba(255,255,255,0.07)', backdropFilter: 'blur(12px)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          >←</button>
          <div>
            <h1 style={{ color: '#ffffff', fontSize: 15, fontWeight: 600, margin: 0, lineHeight: 1.2 }}>United States — Macro Heatmap</h1>
      ...
      <main style={{ position: 'relative', maxWidth: 1600, margin: '0 auto', padding: '28px 24px', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div style={{ ...cardStyle, padding: 0, overflow: 'hidden' }}>
          <div style={{ padding: '16px 20px 12px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <p style={{ color: '#475569', fontSize: 12, margin: 0, marginTop: 3 }}>Z-scores relative to 3-year rolling window &middot; 25 monthly observations &middot; 71 indicators across 7 blocks</p>
          </div>
